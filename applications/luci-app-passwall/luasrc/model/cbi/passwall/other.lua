...
o = s:option(Button, "hide", translate("Hide Menu"), translate(
                 "After the hidden to the display, type in the address bar enter the admin/vpn/passwall/show.<br />such as: http://192.168.9.1/cgi-bin/luci/admin/vpn/passwall/show"))
o.inputstyle = "remove"
