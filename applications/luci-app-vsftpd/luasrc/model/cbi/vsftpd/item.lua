...
o = s:option(Value, "umask", translate("vusers file mode umask"))
o.default = "022"

o = s:option(Value, "maxrate", translate("vusers max transmit rate"), translate("in B/s, 0 means no limitation"))
o.default = "0"
