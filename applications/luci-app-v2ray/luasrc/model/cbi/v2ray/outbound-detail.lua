...
o:depends("ss_security", "tls")
o:value("")
o:value("encipherment", translate("encipherment"))
o:value("verify", translate("verify"))
o:value("issue", translate("issue"))
...
o = s:option(DynamicList, "ss_http_host", "%s - %s" % { "HTTP/2", translate("Domain") })
...
o = s:option(Value, "ss_quic_key", "%s - %s" % { "QUIC", translate("secret key") })
