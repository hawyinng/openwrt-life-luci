...
function generate_gfwlist()
	...
	local file_size = fs.stat(temp, "size")
...
function generate_routelist()
	...
	local file_size_ipv4 = fs.stat(temp_ipv4, "size")
	local file_size_ipv6 = fs.stat(temp_ipv6, "size")
...
function textarea_write(self, section, value)
	...
	value = value:gsub("\r\n?", "\n")
	return fs.writefile(self.filepath, value)
end
