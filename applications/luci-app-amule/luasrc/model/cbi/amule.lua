...
o = s:taboption("general", Value, "mem_percentage", translate("Memory Limit"), translate("Memory usage ratio"))
o.rmempty = false
o.placeholder = "50"
...
o = s:taboption("general", Value, "max_upload", translate("Max upload speed"), translate("Unlimited when set to 0(Unit KB)"))
o.datatype = "uinteger"
o.rmempty = false
o.placeholder = "0"

o = s:taboption("general", Value, "max_download", translate("Max download speed"), translate("Unlimited when set to 0(Unit KB)"))
o.datatype = "uinteger"
o.rmempty = false
o.placeholder = "0"

o = s:taboption("general", Value, "slot_allocation", translate("Slot allocation(KB)"))
o.datatype = "uinteger"
o.rmempty = false
o.placeholder = "2"

o = s:taboption("general", Value, "max_connections", translate("Global Max connections"))
o.datatype = "uinteger"
o.rmempty = false
o.placeholder = "900"
...
o = s:taboption("security", Flag, "ip_filter_system", translate("Use system-wide ipfilter_static.dat if available"))
o.rmempty = false
