...
local file2 = "/etc/dnscrypt-proxy2/blacklist.txt"
cf2 = s:taboption("conf2", Value, "_tmp2")
cf2.description = translate("This is the content of the file '/etc/dnscrypt-proxy2/blacklist.txt'. Make changes as needed, Take effect immediately after saving & Apply.")
