...
function o.write(self, section, value)
	if value == "1" then
		sys.exec("/etc/init.d/mwan3helper enable")
		sys.exec("/etc/init.d/mwan3helper start")
	else
		sys.exec("/etc/init.d/mwan3helper disable")
		sys.exec("/etc/init.d/mwan3helper stop")
	end
