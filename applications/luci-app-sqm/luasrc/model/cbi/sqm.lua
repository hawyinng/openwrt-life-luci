...
verb = s:taboption("tab_basic", ListValue, "verbosity", translate("SQM log level"))
verb:value("0", "silent ("..translate("Silent")..")")
verb:value("1", "error ("..translate("Error")..")")
verb:value("2", "warning ("..translate("Warning")..")")
verb:value("5", "info ("..translate("default")..")")
verb:value("8", "debug ("..translate("Debug")..")")
verb:value("10", "trace ("..translate("Trace")..")")
verb.default = "5"
verb.rmempty = true
...
c = s:taboption("tab_qdisc", ListValue, "qdisc", translate("Queuing disciplines"))
...
sc.default = "piece_of_cake.qos"
sc.rmempty = false
sc.description = qos_desc

ad = s:taboption("tab_qdisc", Flag, "qdisc_advanced", translate("Advanced options"))
ad.default = false
ad.rmempty = true
...
ad2 = s:taboption("tab_qdisc", Flag, "qdisc_really_really_advanced", translate("Dangerous Configuration"))
ad2.default = false
ad2.rmempty = true
