...
en.default = 0
en.rmempty = false
en.description = translate("启用后，路由器自动分流解锁，大部分设备无需设置代理。")
...
o.description = string.format(translate("NodeJS 主程序版本") ..  "<strong><font color=\"green\">: %s </font></strong>", ver)
o.inputstyle = "reload"
o.write = function()
	sys.exec("/usr/share/UnblockNeteaseMusic/update_core.sh luci_update 2>&1")
