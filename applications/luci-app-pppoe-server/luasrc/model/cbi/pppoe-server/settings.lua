...
function o.write(self, section, value)
	if value == "1" then
		sys.exec("/etc/init.d/pppoe-server enable")
		sys.exec("/etc/init.d/pppoe-server start")
	else
		sys.exec("/etc/init.d/pppoe-server stop")
		sys.exec("/etc/init.d/pppoe-server disable")
	end
