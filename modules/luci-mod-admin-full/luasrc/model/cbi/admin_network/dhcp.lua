...
s:tab("template", translate("Edit configuration"))
...
tmpl.description = translate("This is the content of the file '/etc/dnsmasq.conf'. Make changes as needed, Take effect immediately after saving & Apply.")
tmpl.template = "cbi/tvalue"
tmpl.rows = 20

function tmpl.cfgvalue(self, section)
	return nixio.fs.readfile("/etc/dnsmasq.conf")
end
